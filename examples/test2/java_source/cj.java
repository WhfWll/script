  ...
  extends org.apache.http.conn.ssl.SSLSocketFactory
{
    ...
    throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException, UnrecoverableKeyException
  {
    super(paramKeyStore);
    new ck();
    jdField_a_of_type_JavaxNetSslSSLContext.init(jdField_a_of_type_JavaxNetSslKeyManagerFactory.getKeyManagers(), jdField_a_of_type_JavaxNetSslTrustManagerFactory.getTrustManagers(), null);
  }
  ...
  public final Socket createSocket()
    throws IOException
  {
    return jdField_a_of_type_JavaxNetSslSSLContext.getSocketFactory().createSocket();
  }
  
  public final Socket createSocket(Socket paramSocket, String paramString, int paramInt, boolean paramBoolean)
    throws IOException, UnknownHostException
  {
    return jdField_a_of_type_JavaxNetSslSSLContext.getSocketFactory().createSocket(paramSocket, paramString, paramInt, paramBoolean);
  }
}
