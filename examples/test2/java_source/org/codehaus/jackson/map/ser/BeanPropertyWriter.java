  ...
  implements BeanProperty
{
    ...
    throws JsonMappingException
  {
    ...
    for (paramClass = paramPropertySerializerMap.findAndAddSerializer(_nonTrivialBaseType.forcedNarrowBy(paramClass), paramSerializerProvider, this);; paramClass = paramPropertySerializerMap.findAndAddSerializer(paramClass, paramSerializerProvider, this))
    {
    ...
    throws Exception
  {
    ...
    paramObject.serializeWithType(localObject, paramJsonGenerator, paramSerializerProvider, _typeSerializer);
  }
