  ...
  implements ResolvableSerializer
{
    ...
    throws IOException, JsonGenerationException
  {
    ...
    label289:
    label291:
    for (Object localObject1 = _findAndAddDynamic((PropertySerializerMap)localObject1, _valueType.forcedNarrowBy(localClass), paramSerializerProvider);; localObject2 = _findAndAddDynamic((PropertySerializerMap)localObject2, localClass, paramSerializerProvider))
    {
