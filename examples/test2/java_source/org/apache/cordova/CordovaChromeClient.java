  ...
  extends WebChromeClient
{
  ...
  public boolean onConsoleMessage(ConsoleMessage paramConsoleMessage)
  {
    if (paramConsoleMessage.message() != null) {
      LOG.d(TAG, paramConsoleMessage.message());
    }
  ...
  {
    LOG.d(TAG, "DroidGap:  onExceededDatabaseQuota estimatedSize: %d  currentQuota: %d  totalUsedQuota: %d", new Object[] { Long.valueOf(paramLong2), Long.valueOf(paramLong1), Long.valueOf(paramLong3) });
    if (paramLong2 < MAX_QUOTA)
    {
      LOG.d(TAG, "calling quotaUpdater.updateQuota newQuota: %d", new Object[] { Long.valueOf(paramLong2) });
  ...
  public boolean onJsPrompt(WebView paramWebView, final String paramString1, String paramString2, String paramString3, final JsPromptResult paramJsPromptResult)
  {
    ...
    for (;;)
    {
      ...
      {
        paramString1 = appView.exposedJsApi.retrieveJsMessages();
        paramWebView = paramString1;
        if (paramString1 == null) {
          paramWebView = "";
        }
