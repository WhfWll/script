  ...
  public boolean shouldOverrideUrlLoading(WebView paramWebView, String paramString)
  {
    ...
    for (;;)
    {
      ...
      if (paramString.startsWith("tel:"))
      {
        ...
        {
          LOG.e("Cordova", "Error dialing " + paramString + ": " + paramWebView.toString());
        }
      }
      else if (paramString.startsWith("geo:"))
      {
        ...
        {
          LOG.e("Cordova", "Error showing map " + paramString + ": " + paramWebView.toString());
        }
      }
      else if (paramString.startsWith("mailto:"))
      {
        ...
        {
          LOG.e("Cordova", "Error sending email " + paramString + ": " + paramWebView.toString());
        }
      }
      else
      {
        if (paramString.startsWith("sms:")) {
          for (;;)
          {
            ...
            {
              LOG.e("Cordova", "Error sending sms " + paramString + ":" + paramWebView.toString());
            }
            break;
            label437:
        ...
        {
          LOG.e("Cordova", "Error loading url " + paramString, paramWebView);
        }
      }
    }
  }
