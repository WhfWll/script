...
public abstract class SQLiteOpenHelper
{
  ...
  public SQLiteDatabase getWritableDatabase(String paramString)
  {
    ...
    //   359: ifnull -17 -> 342
    //   362: aload_3
    //   363: invokevirtual 78	net/sqlcipher/database/SQLiteDatabase:close	()V
    //   366: goto -24 -> 342
    //   369: aload_0
    //   370: getfield 34	net/sqlcipher/database/SQLiteOpenHelper:mDatabase	Lnet/sqlcipher/database/SQLiteDatabase;
    //   373: ifnull +10 -> 383
    //   376: aload_0
    //   377: getfield 34	net/sqlcipher/database/SQLiteOpenHelper:mDatabase	Lnet/sqlcipher/database/SQLiteDatabase;
    //   380: invokevirtual 178	net/sqlcipher/database/SQLiteDatabase:unlock	()V
    //   383: aload_1
    //   384: astore_3
    //   385: aload_1
    //   386: ifnull -352 -> 34
    //   389: aload_1
    //   390: invokevirtual 78	net/sqlcipher/database/SQLiteDatabase:close	()V
    //   393: aload_1
    //   394: astore_3
    //   395: goto -361 -> 34
    //   398: astore_3
    ...
    //   293	297	302	finally
    //   299	302	302	finally
    //   179	186	398	java/lang/Exception
    //   323	330	402	java/lang/Exception
  }
