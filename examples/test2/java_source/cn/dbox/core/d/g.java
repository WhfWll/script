  ...
  extends Thread
{
  ...
  public void run()
  {
    ...
    label186:
    d.b(g.class.getSimpleName(), "fileSize:" + e + " downloadSizeMore:" + g);
    f = (e / h);
    g = (e % h);
    ...
    {
      if (i1 != h - 1) {}
      for (i localI = new i(localURL, localFile, f * i1 + l, (i1 + 1) * f - 1, m, j, n); localI.a(); localI = new i(localURL, localFile, f * i1 + l, (i1 + 1) * f - 1 + g, m, j, n))
      {
        j.a(100);
        return;
      }
      localI.setName("Thread" + i1);
      localI.start();
      arrayOfI[i1] = localI;
      i1 += 1;
    }
