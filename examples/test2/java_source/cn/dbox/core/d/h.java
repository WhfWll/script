...
public class h
{
  private static d a = new d(h.class.getSimpleName());
  ...
  protected static String a(Context paramContext)
  {
    ...
    {
      a.e(h.class.getSimpleName(), "Cannot access user's network type.  Permissions are not set.");
      paramContext = "";
    }
    int i;
    String str;
  ...
  protected static java.net.Proxy b(Context paramContext)
  {
    ...
    //   3: astore 4
    //   5: aload_0
    //   6: invokestatic 80	cn/dbox/core/d/h:c	(Landroid/content/Context;)Landroid/database/Cursor;
    //   9: astore_0
    //   10: aload_0
    //   11: ifnull +219 -> 230
    //   14: aload_0
    ...
    //   74: astore_3
    //   75: getstatic 29	cn/dbox/core/d/h:a	Lcn/dbox/core/h/d;
    //   78: ldc 2
    ...
    //   120: invokevirtual 127	cn/dbox/core/h/d:a	(Ljava/lang/Object;Ljava/lang/String;)V
    //   123: aload_2
    //   124: ifnull +164 -> 288
    //   127: aload_2
    //   128: ldc 49
    ...
    //   146: ifne +142 -> 288
    //   149: getstatic 29	cn/dbox/core/d/h:a	Lcn/dbox/core/h/d;
    //   152: ldc 2
    ...
    //   185: invokevirtual 127	cn/dbox/core/h/d:a	(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    //   245: aload_3
    //   246: astore_0
    //   247: getstatic 29	cn/dbox/core/d/h:a	Lcn/dbox/core/h/d;
    //   250: aload_0
    //   251: invokevirtual 163	cn/dbox/core/h/d:a	(Ljava/lang/Throwable;)V
    //   254: aload 4
    //   256: astore_0
    //   257: goto -43 -> 214
    //   260: astore_3
    //   261: aconst_null
    //   262: astore_2
    //   263: getstatic 29	cn/dbox/core/d/h:a	Lcn/dbox/core/h/d;
    //   266: aload_3
    //   267: invokevirtual 163	cn/dbox/core/h/d:a	(Ljava/lang/Throwable;)V
    //   270: aload 4
    //   272: astore_0
    //   273: goto -59 -> 214
    //   276: astore_3
  ...
  private static Cursor c(Context paramContext)
  {
    ...
    {
      a.a(h.class.getSimpleName(), "Download network is wifi, don't read apn.");
      return null;
    }
