  ...
  implements TextWatcher, View.OnFocusChangeListener
{
  ...
  private void init()
  {
    ...
    if (mClearDrawable == null) {
      mClearDrawable = getResources().getDrawable(DDrawable.getDrawableInt(getContext(), "u_progress_cancelbtn"));
    }
  ...
  public void onTextChanged(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if ((mEditextChangeZeroListener != null) && (paramCharSequence.length() == 0)) {
        mEditextChangeZeroListener.textChange();
      }
      return;
    }
  }
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    if ((getCompoundDrawables()[2] != null) && (paramMotionEvent.getAction() == 1)) {
      if ((paramMotionEvent.getX() <= getWidth() - getPaddingRight() - mClearDrawable.getIntrinsicWidth()) || (paramMotionEvent.getX() >= getWidth() - getPaddingRight())) {
        break label79;
      }
    }
    for (;;)
  ...
  {
    if (paramBoolean) {}
    for (Drawable localDrawable = mClearDrawable;; localDrawable = null)
    {
  ...
  {
    mEditextChangeZeroListener = paramEditextChangeZeroListener;
  }
