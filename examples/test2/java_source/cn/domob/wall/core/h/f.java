...
public class f
{
  ...
  public static String d(String paramString)
  {
    ...
    //   3: dup
    //   4: aload_0
    //   5: invokespecial 474	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   8: astore_2
    //   9: aload_2
    //   10: astore_0
    //   11: sipush 1024
    ...
    //   18: astore_0
    //   19: ldc_w 419
    //   22: invokestatic 424	java/security/MessageDigest:getInstance	(Ljava/lang/String;)Ljava/security/MessageDigest;
    //   25: astore 4
    //   27: aload_2
    //   28: astore_0
    //   29: aload_2
    //   30: aload_3
    //   31: invokevirtual 480	java/io/InputStream:read	([B)I
    //   34: istore_1
    //   35: iload_1
    //   36: ifle +63 -> 99
    //   39: aload_2
    ...
    //   44: iconst_0
    //   45: iload_1
    //   46: invokevirtual 483	java/security/MessageDigest:update	([BII)V
    //   49: goto -22 -> 27
    //   52: astore_3
    //   53: aload_2
    //   54: astore_0
    //   55: getstatic 39	cn/domob/wall/core/h/f:a	Lcn/domob/wall/core/h/d;
    //   58: ldc -119
    //   60: new 143	java/lang/StringBuilder
    //   63: dup
    //   64: invokespecial 144	java/lang/StringBuilder:<init>	()V
    //   67: ldc_w 485
    //   70: invokevirtual 212	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   73: aload_3
    //   74: invokevirtual 488	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   77: invokevirtual 212	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   80: invokevirtual 215	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   83: invokevirtual 491	cn/domob/wall/core/h/d:e	(Ljava/lang/Object;Ljava/lang/String;)V
    //   86: aload_2
    //   87: ifnull +7 -> 94
    //   90: aload_2
    //   91: invokevirtual 494	java/io/InputStream:close	()V
    //   94: ldc -119
    //   96: astore_3
    //   97: aload_3
    //   98: areturn
    ...
    //   100: astore_0
    //   101: aload 4
    //   103: invokevirtual 433	java/security/MessageDigest:digest	()[B
    //   106: ldc -119
    //   108: invokestatic 435	cn/domob/wall/core/h/f:a	([BLjava/lang/String;)Ljava/lang/String;
    //   111: astore_3
    //   112: aload_3
    //   113: astore_0
    //   114: aload_0
    ...
    //   117: ifnull -20 -> 97
    //   120: aload_2
    //   121: invokevirtual 494	java/io/InputStream:close	()V
    //   124: aload_0
    //   125: areturn
    //   126: astore_2
    //   127: getstatic 39	cn/domob/wall/core/h/f:a	Lcn/domob/wall/core/h/d;
    //   130: aload_2
    //   131: invokevirtual 184	cn/domob/wall/core/h/d:a	(Ljava/lang/Throwable;)V
    //   134: aload_0
    //   135: areturn
    //   136: astore_0
    //   137: getstatic 39	cn/domob/wall/core/h/f:a	Lcn/domob/wall/core/h/d;
    //   140: aload_0
    //   141: invokevirtual 184	cn/domob/wall/core/h/d:a	(Ljava/lang/Throwable;)V
    //   144: goto -50 -> 94
    //   147: astore_2
    //   148: aconst_null
    //   149: astore_0
    ...
    //   151: ifnull +7 -> 158
    //   154: aload_0
    //   155: invokevirtual 494	java/io/InputStream:close	()V
    //   158: aload_2
    //   159: athrow
    //   160: astore_0
    //   161: getstatic 39	cn/domob/wall/core/h/f:a	Lcn/domob/wall/core/h/d;
    //   164: aload_0
    //   165: invokevirtual 184	cn/domob/wall/core/h/d:a	(Ljava/lang/Throwable;)V
    //   168: goto -10 -> 158
    //   171: astore_2
    //   172: goto -22 -> 150
    //   175: astore_3
