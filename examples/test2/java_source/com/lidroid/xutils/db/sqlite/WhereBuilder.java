...
public class WhereBuilder
{
  ...
  private void appendCondition(String paramString1, String paramString2, String paramString3, Object paramObject)
  {
    ...
    for (;;)
    {
      whereItems.add(localStringBuilder.toString());
      return;
        ...
        if ("IN".equalsIgnoreCase(paramString1))
        {
          ...
          for (;;)
          {
            if (paramString1 != null)
            {
              ...
              paramString1 = ColumnUtils.convert2DbColumnValueIfNeeded(paramObject.next());
  ...
  public String toString()
  {
    ...
    StringBuilder localStringBuilder = new StringBuilder();
    Iterator localIterator = whereItems.iterator();
    for (;;)
    {
