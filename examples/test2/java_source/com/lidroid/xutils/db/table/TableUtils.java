...
public class TableUtils
{
  ...
  static HashMap<String, Column> getColumnMap(Class<?> paramClass)
  {
    ...
    //   6: aload_0
    //   7: invokevirtual 121	java/lang/Class:getName	()Ljava/lang/String;
    //   10: invokevirtual 122	java/util/concurrent/ConcurrentHashMap:containsKey	(Ljava/lang/Object;)Z
    //   13: ifeq +22 -> 35
    //   16: getstatic 18	com/lidroid/xutils/db/table/TableUtils:entityColumnsMap	Ljava/util/concurrent/ConcurrentHashMap;
    //   19: aload_0
    //   20: invokevirtual 121	java/lang/Class:getName	()Ljava/lang/String;
    //   23: invokevirtual 126	java/util/concurrent/ConcurrentHashMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    //   38: dup
    //   39: invokespecial 127	java/util/HashMap:<init>	()V
    //   42: astore_1
    //   43: aload_0
    //   44: aload_0
    //   45: invokestatic 131	com/lidroid/xutils/db/table/TableUtils:getPrimaryKeyFieldName	(Ljava/lang/Class;)Ljava/lang/String;
    //   48: aload_1
    ...
    //   55: aload_0
    //   56: invokevirtual 121	java/lang/Class:getName	()Ljava/lang/String;
    //   59: aload_1
    //   60: invokevirtual 132	java/util/concurrent/ConcurrentHashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   63: pop
    //   64: aload_1
    //   65: astore_0
    //   66: goto -36 -> 30
  ...
  static Id getId(Class<?> paramClass)
  {
    ...
    {
      paramClass = (Id)entityIdMap.get(paramClass.getName());
      return paramClass;
    }
    ...
    else
    {
      for (;;)
      {
        ...
        if (localObject2.getAnnotation(com.lidroid.xutils.db.annotation.Id.class) == null) {
          break label231;
        }
    ...
    {
      localObject2 = arrayOfField[i];
      if (!"id".equals(localObject2.getName()))
      {
        if (!"_id".equals(localObject2.getName())) {
          break label241;
        }
        break label238;
        localObject1 = new Id(paramClass, localObject2);
        entityIdMap.put(paramClass.getName(), localObject1);
