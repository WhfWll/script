...
public class HttpUtils
{
  ...
  public HttpUtils(int paramInt, String paramString)
  {
    ...
    httpClient = new DefaultHttpClient(new ThreadSafeClientConnManager(localBasicHttpParams, paramString), localBasicHttpParams);
  ...
  {
    paramRequestCallBack = new HttpHandler(httpClient, httpContext, responseTextCharset, paramRequestCallBack);
    paramRequestCallBack.setExpiry(currentRequestExpiry);
    paramRequestCallBack.setHttpRedirectHandler(httpRedirectHandler);
    paramHttpRequest.setRequestParams(paramRequestParams, paramRequestCallBack);
    if (paramRequestParams != null) {
      paramRequestCallBack.setPriority(paramRequestParams.getPriority());
    }
  ...
  {
    SyncHttpHandler localSyncHttpHandler = new SyncHttpHandler(httpClient, httpContext, responseTextCharset);
    localSyncHttpHandler.setExpiry(currentRequestExpiry);
    localSyncHttpHandler.setHttpRedirectHandler(httpRedirectHandler);
  ...
  {
    httpContext.setAttribute("http.cookie-store", paramCookieStore);
    return this;
  }
  
  public HttpUtils configCurrentHttpCacheExpiry(long paramLong)
  {
    currentRequestExpiry = paramLong;
    return this;
  }
  ...
  {
    httpRedirectHandler = paramHttpRedirectHandler;
    return this;
  }
  
  public HttpUtils configRegisterScheme(Scheme paramScheme)
  {
    httpClient.getConnectionManager().getSchemeRegistry().register(paramScheme);
    return this;
  }
  
  public HttpUtils configRequestRetryCount(int paramInt)
  {
    httpClient.setHttpRequestRetryHandler(new RetryHandler(paramInt));
    return this;
  }
  ...
  {
    if (!TextUtils.isEmpty(paramString)) {
      responseTextCharset = paramString;
    }
    return this;
  }
  ...
  public HttpUtils configSSLSocketFactory(SSLSocketFactory paramSSLSocketFactory)
  {
    ...
    httpClient.getConnectionManager().getSchemeRegistry().register(paramSSLSocketFactory);
    return this;
  }
  
  public HttpUtils configSoTimeout(int paramInt)
  {
    HttpConnectionParams.setSoTimeout(httpClient.getParams(), paramInt);
    return this;
  }
  ...
  {
    HttpProtocolParams.setUserAgent(httpClient.getParams(), paramString);
    return this;
  }
  ...
  public HttpHandler<File> download(HttpRequest.HttpMethod paramHttpMethod, String paramString1, String paramString2, RequestParams paramRequestParams, boolean paramBoolean1, boolean paramBoolean2, RequestCallBack<File> paramRequestCallBack)
  {
    ...
    paramString1 = new HttpHandler(httpClient, httpContext, responseTextCharset, paramRequestCallBack);
    paramString1.setExpiry(currentRequestExpiry);
    paramString1.setHttpRedirectHandler(httpRedirectHandler);
    if (paramRequestParams != null)
    {
      paramHttpMethod.setRequestParams(paramRequestParams, paramString1);
      paramString1.setPriority(paramRequestParams.getPriority());
    }
