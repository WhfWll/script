  ...
  extends GenericMapMaker<Object, Object>
{
    ...
    implements Serializable
  {
    ...
    static
    {
      JniLib.a(ComputingMapAdapter.class, 663);
    }
    ...
    implements MapMaker.Cache<K, V>
  {
    ...
    static
    {
      JniLib.a(NullComputingConcurrentMap.class, 665);
    }
    ...
    implements ConcurrentMap<K, V>, Serializable
  {
    ...
    static
    {
      JniLib.a(NullConcurrentMap.class, 664);
    }
    
    NullConcurrentMap(MapMaker paramMapMaker)
    {
      evictionListener = paramMapMaker.getEvictionListener();
    }
