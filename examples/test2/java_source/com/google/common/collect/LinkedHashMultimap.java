  ...
  extends AbstractSetMultimap<K, V>
{
  ...
  static
  {
    JniLib.a(LinkedHashMultimap.class, 603);
  }
  ...
  private LinkedHashMultimap(int paramInt1, int paramInt2)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      linkedEntries = new LinkedHashSet((int)Math.min(1073741824L, paramInt1 * paramInt2));
      return;
    }
  }
  ...
  private LinkedHashMultimap(Multimap<? extends K, ? extends V> paramMultimap)
  {
    ...
    linkedEntries = new LinkedHashSet(Maps.capacity(paramMultimap.size()));
    ...
    extends ForwardingSet<V>
  {
    ...
    static
    {
      JniLib.a(SetDecorator.class, 602);
    }
    
    SetDecorator(Set<V> paramSet)
    {
      Object localObject;
      delegate = localObject;
      key = paramSet;
    }
