...
public final class Maps
{
    ...
    extends AbstractMap<K, V>
  {
    ...
    public V put(K paramK, V paramV)
    {
      ...
      return unfiltered.put(paramK, paramV);
    }
    ...
    public V remove(Object paramObject)
    {
      if (containsKey(paramObject)) {
        return unfiltered.remove(paramObject);
      }
      return null;
    }
    ...
    extends Maps.ImprovedAbstractMap<K, V>
  {
    ...
    static
    {
      JniLib.a(AbstractMapWrapper.class, 673);
    }
    ...
    extends AbstractSet<Map.Entry<K, V>>
  {
    ...
    static
    {
      JniLib.a(EntrySetImpl.class, 674);
    }
    
    EntrySetImpl(Map<K, V> paramMap, Supplier<Iterator<Map.Entry<K, V>>> paramSupplier)
    {
      map = ((Map)Preconditions.checkNotNull(paramMap));
      entryIteratorSupplier = ((Supplier)Preconditions.checkNotNull(paramSupplier));
    }
    ...
    extends Maps.AbstractFilteredMap<K, V>
  {
    ...
    static
    {
      JniLib.a(FilteredEntryMap.class, 680);
    }
    ...
    extends Maps.AbstractFilteredMap<K, V>
  {
    ...
    static
    {
      JniLib.a(FilteredKeyMap.class, 681);
    }
    ...
    implements MapDifference<K, V>
  {
    ...
    static
    {
      JniLib.a(MapDifferenceImpl.class, 684);
    }
    ...
    {
      areEqual = paramBoolean;
      onlyOnLeft = paramMap1;
      onlyOnRight = paramMap2;
      onBoth = paramMap3;
      differences = paramMap;
    }
    ...
    extends AbstractMap<K, V2>
  {
    ...
    static
    {
      JniLib.a(TransformedEntriesMap.class, 688);
    }
    ...
    implements BiMap<K, V>, Serializable
  {
    ...
    static
    {
      JniLib.a(UnmodifiableBiMap.class, 689);
    }
    ...
    extends ForwardingCollection<Map.Entry<K, V>>
  {
    ...
    static
    {
      JniLib.a(UnmodifiableEntries.class, 691);
    }
    ...
    implements Set<Map.Entry<K, V>>
  {
    static
    {
      JniLib.a(UnmodifiableEntrySet.class, 692);
    }
    ...
    implements MapDifference.ValueDifference<V>
  {
    ...
    static
    {
      JniLib.a(ValueDifferenceImpl.class, 693);
    }
