  ...
  extends StandardRowSortedTable<R, C, V>
{
  ...
  static
  {
    JniLib.a(TreeBasedTable.class, 860);
  }
    ...
    extends AbstractIterator<T>
  {
    ...
    static
    {
      JniLib.a(MergingIterator.class, 859);
    }
    ...
    public MergingIterator(Iterable<? extends Iterator<T>> paramIterable, Comparator<? super T> paramComparator)
    {
      ...
      queue = new PriorityQueue(Math.max(1, Iterables.size(paramIterable)), paramComparator);
