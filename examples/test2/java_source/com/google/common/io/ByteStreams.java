...
public final class ByteStreams
{
  ...
  static
  {
    JniLib.a(ByteStreams.class, 876);
  }
    ...
    implements ByteArrayDataInput
  {
    ...
    static
    {
      JniLib.a(ByteArrayDataInputStream.class, 874);
    }
    
    ByteArrayDataInputStream(byte[] paramArrayOfByte)
    {
      input = new DataInputStream(new ByteArrayInputStream(paramArrayOfByte));
    }
    
    ByteArrayDataInputStream(byte[] paramArrayOfByte, int paramInt)
    {
      input = new DataInputStream(new ByteArrayInputStream(paramArrayOfByte, paramInt, paramArrayOfByte.length - paramInt));
    }
    ...
    implements ByteArrayDataOutput
  {
    ...
    static
    {
      JniLib.a(ByteArrayDataOutputStream.class, 875);
    }
