...
final class z
  implements Runnable
{
  z(String paramString, c paramC, Context paramContext, StatSpecifyReportedInfo paramStatSpecifyReportedInfo) {}
  ...
  public final void run()
  {
    ...
    StatServiceImpl.f().warn("No start time found for custom event: " + b.toString() + ", lost trackCustomBeginKVEvent()?");
  }
}
