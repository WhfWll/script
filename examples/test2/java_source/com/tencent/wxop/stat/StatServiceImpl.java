...
public class StatServiceImpl
{
  ...
  static int a(Context paramContext, boolean paramBoolean, StatSpecifyReportedInfo paramStatSpecifyReportedInfo)
  {
    ...
    for (int i1 = 1;; i1 = 0)
    {
      ...
      String str = k;
      if (k.a(paramStatSpecifyReportedInfo)) {
  ...
  static void a(Context paramContext, StatSpecifyReportedInfo paramStatSpecifyReportedInfo)
  {
    if (c(paramContext) != null)
    {
      ...
      StatConfig.a(0);
      StatConfig.b();
      new aq(new com.tencent.wxop.stat.a.l(paramContext, l, b(), paramStatSpecifyReportedInfo)).a();
    }
  }
  ...
  static JSONObject b()
  {
    ...
    try
    {
      ...
      if (bd != 0) {
        localJSONObject2.put("v", bd);
      }
      localJSONObject1.put(Integer.toString(ba), localJSONObject2);
      localJSONObject2 = new JSONObject();
      if (ad != 0) {
        localJSONObject2.put("v", ad);
      }
      localJSONObject1.put(Integer.toString(aa), localJSONObject2);
  ...
  private static void b(Context paramContext, StatAccount paramStatAccount, StatSpecifyReportedInfo paramStatSpecifyReportedInfo)
  {
    try
    {
      new aq(new com.tencent.wxop.stat.a.a(paramContext, a(paramContext, false, paramStatSpecifyReportedInfo), paramStatAccount, paramStatSpecifyReportedInfo)).a();
      return;
    }
  ...
  {
    boolean bool2 = false;
    long l1 = com.tencent.wxop.stat.common.p.a(paramContext, StatConfig.c, 0L);
    long l2 = k.b("2.0.3");
    boolean bool1 = true;
    if (l2 <= l1)
    {
    ...
    l1 = com.tencent.wxop.stat.common.p.a(paramContext, StatConfig.d, 0L);
  ...
  static e c(Context paramContext)
  {
    ...
    //   14: ifnonnull +7 -> 21
    //   17: aload_0
    //   18: invokestatic 342	com/tencent/wxop/stat/StatServiceImpl:a	(Landroid/content/Context;)V
    //   21: ldc 2
    //   23: monitorexit
    ...
    //   32: aload_0
    //   33: invokevirtual 344	com/tencent/wxop/stat/common/StatLogger:error	(Ljava/lang/Throwable;)V
    //   36: iconst_0
    //   37: invokestatic 340	com/tencent/wxop/stat/StatConfig:setEnableStatService	(Z)V
    //   40: goto -19 -> 21
    //   43: astore_0
    //   44: ldc 2
    //   46: monitorexit
  ...
  static void d(Context paramContext)
  {
    ...
    try
    {
      com.tencent.wxop.stat.a.i localI = new com.tencent.wxop.stat.a.i(paramContext);
      i.b(paramContext).a(localI, new t());
      return;
    }
  ...
  static void e(Context paramContext)
  {
    ...
    com.tencent.wxop.stat.common.p.b(paramContext, "last_period_ts", c);
  ...
  public static boolean startStatService(Context paramContext, String paramString1, String paramString2, StatSpecifyReportedInfo paramStatSpecifyReportedInfo)
  {
    for (;;)
    {
      try
      {
        ...
        q.d("MTA SDK version, current: " + "2.0.3" + " ,required: " + paramString2);
      }
      catch (Throwable paramContext)
      {
        q.e(paramContext);
