...
public class au
{
  ...
  private au(Context paramContext)
  {
    try
    {
      e = new com.tencent.wxop.stat.common.e();
      i = paramContext.getApplicationContext();
      l = new ConcurrentHashMap();
      f = k.r(paramContext);
      g = ("pri_" + k.r(paramContext));
      c = new bc(i, f);
      d = new bc(i, g);
      a(true);
      a(false);
  ...
  private void a(com.tencent.wxop.stat.a.e paramE, h paramH, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (!paramBoolean)
        {
          localObject1 = localSQLiteDatabase;
          localObject2 = localSQLiteDatabase;
          if (a > StatConfig.getMaxStoreEventCount())
          {
            localObject1 = localSQLiteDatabase;
            localObject2 = localSQLiteDatabase;
            ...
            localObject1 = localSQLiteDatabase;
            localObject2 = localSQLiteDatabase;
            a -= c.getWritableDatabase().delete("events", "event_id in (select event_id from events where timestamp in (select min(timestamp) from events) limit 1)", null);
          }
        }
        localObject1 = localSQLiteDatabase;
        localObject2 = localSQLiteDatabase;
        ...
        localObject1 = localSQLiteDatabase;
        localObject2 = localSQLiteDatabase;
        localContentValues.put("content", q.b(str));
        localObject1 = localSQLiteDatabase;
        localObject2 = localSQLiteDatabase;
  ...
  private void a(List<bd> paramList, int paramInt, boolean paramBoolean)
  {
    ...
    //   31: aload_0
    //   32: iload_3
    //   33: invokespecial 223	com/tencent/wxop/stat/au:c	(Z)Landroid/database/sqlite/SQLiteDatabase;
    //   36: astore 6
    //   38: iload_2
    //   39: iconst_2
    ...
    //   127: astore 5
    //   129: aload 6
    //   131: invokevirtual 228	android/database/sqlite/SQLiteDatabase:beginTransaction	()V
    //   134: aload 6
    //   136: astore 5
    //   138: aload 6
    //   140: aload 7
    ...
    //   196: astore 5
    //   198: aload 6
    //   200: invokevirtual 300	android/database/sqlite/SQLiteDatabase:setTransactionSuccessful	()V
    //   203: aload 6
    //   205: ifnull -184 -> 21
    //   208: aload 6
    //   210: invokevirtual 303	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   213: goto -192 -> 21
    //   216: astore_1
    ...
    //   339: ifnull -318 -> 21
    //   342: aload 6
    //   344: invokevirtual 303	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   347: goto -326 -> 21
    //   350: astore_1
    ...
    //   367: ifnull +8 -> 375
    //   370: aload 5
    //   372: invokevirtual 303	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   375: aload_1
    //   376: athrow
    //   377: astore 5
  ...
  private void a(List<bd> paramList, boolean paramBoolean)
  {
    ...
    //   165: aload_0
    //   166: iload_2
    //   167: invokespecial 223	com/tencent/wxop/stat/au:c	(Z)Landroid/database/sqlite/SQLiteDatabase;
    //   170: astore 6
    //   172: aload 6
    //   174: astore_1
    //   175: aload 6
    //   177: astore 5
    //   179: aload 6
    //   181: invokevirtual 228	android/database/sqlite/SQLiteDatabase:beginTransaction	()V
    //   184: aload 6
    //   186: astore_1
    //   187: aload 6
    //   189: astore 5
    ...
    //   200: aconst_null
    //   201: invokevirtual 248	android/database/sqlite/SQLiteDatabase:delete	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    //   204: istore_3
    //   205: aload 6
    //   207: astore_1
    //   208: aload 6
    //   210: astore 5
    //   212: invokestatic 184	com/tencent/wxop/stat/StatConfig:isDebugEnable	()Z
    //   215: ifeq +58 -> 273
    //   218: aload 6
    //   220: astore_1
    //   221: aload 6
    //   223: astore 5
    //   225: getstatic 40	com/tencent/wxop/stat/au:h	Lcom/tencent/wxop/stat/common/StatLogger;
    //   228: new 96	java/lang/StringBuilder
    //   231: dup
    //   232: ldc_w 366
    //   235: invokespecial 101	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   238: iload 4
    //   240: invokevirtual 189	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   243: ldc_w 368
    ...
    //   263: iload_3
    //   264: invokevirtual 189	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   267: invokevirtual 109	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   270: invokevirtual 194	com/tencent/wxop/stat/common/StatLogger:i	(Ljava/lang/Object;)V
    //   273: aload 6
    //   275: astore_1
    //   276: aload 6
    //   278: astore 5
    //   280: aload_0
    //   281: aload_0
    //   282: getfield 65	com/tencent/wxop/stat/au:a	I
    //   285: iload_3
    //   286: isub
    //   287: putfield 65	com/tencent/wxop/stat/au:a	I
    //   290: aload 6
    //   292: astore_1
    //   293: aload 6
    //   295: astore 5
    //   297: aload 6
    //   299: invokevirtual 300	android/database/sqlite/SQLiteDatabase:setTransactionSuccessful	()V
    //   302: aload 6
    //   304: astore_1
    //   305: aload 6
    //   307: astore 5
    //   309: aload_0
    //   310: invokespecial 119	com/tencent/wxop/stat/au:f	()V
    //   313: aload 6
    //   315: ifnull -296 -> 19
    //   318: aload 6
    //   320: invokevirtual 303	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   323: goto -304 -> 19
    //   326: astore_1
    //   327: getstatic 40	com/tencent/wxop/stat/au:h	Lcom/tencent/wxop/stat/common/StatLogger;
    //   330: aload_1
    //   331: invokevirtual 131	com/tencent/wxop/stat/common/StatLogger:e	(Ljava/lang/Throwable;)V
    //   334: goto -315 -> 19
    //   337: astore_1
    //   338: aload_0
    //   339: monitorexit
    ...
    //   344: aload_1
    //   345: astore 5
    //   347: getstatic 40	com/tencent/wxop/stat/au:h	Lcom/tencent/wxop/stat/common/StatLogger;
    //   350: aload 6
    //   352: invokevirtual 131	com/tencent/wxop/stat/common/StatLogger:e	(Ljava/lang/Throwable;)V
    //   355: aload_1
    //   356: ifnull -337 -> 19
    //   359: aload_1
    //   360: invokevirtual 303	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   363: goto -344 -> 19
    //   366: astore_1
    //   367: getstatic 40	com/tencent/wxop/stat/au:h	Lcom/tencent/wxop/stat/common/StatLogger;
    //   370: aload_1
    //   371: invokevirtual 131	com/tencent/wxop/stat/common/StatLogger:e	(Ljava/lang/Throwable;)V
    //   374: goto -355 -> 19
    //   377: astore_1
    //   378: aload 5
    //   380: ifnull +8 -> 388
    //   383: aload 5
    //   385: invokevirtual 303	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   388: aload_1
    //   389: athrow
    //   390: astore 5
    //   392: getstatic 40	com/tencent/wxop/stat/au:h	Lcom/tencent/wxop/stat/common/StatLogger;
    //   395: aload 5
    //   397: invokevirtual 131	com/tencent/wxop/stat/common/StatLogger:e	(Ljava/lang/Throwable;)V
    //   400: goto -12 -> 388
    //   403: iload_3
    //   404: iconst_1
    //   405: iadd
  ...
  /* Error */
  private void b(com.tencent.wxop.stat.a.e paramE, h paramH, boolean paramBoolean1, boolean paramBoolean2)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: invokestatic 231	com/tencent/wxop/stat/StatConfig:getMaxStoreEventCount	()I
    //   5: ifle +25 -> 30
    ...
    //   25: aload_2
    //   26: iload_3
    //   27: invokespecial 427	com/tencent/wxop/stat/au:a	(Lcom/tencent/wxop/stat/a/e;Lcom/tencent/wxop/stat/h;Z)V
    //   30: aload_0
    //   31: monitorexit
    //   32: return
    ...
    //   112: aload_1
    //   113: invokevirtual 255	com/tencent/wxop/stat/a/e:g	()Ljava/lang/String;
    //   116: invokevirtual 105	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   119: invokevirtual 109	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   122: invokevirtual 194	com/tencent/wxop/stat/common/StatLogger:i	(Ljava/lang/Object;)V
    //   125: aload_0
    ...
    //   146: if_icmplt +7 -> 153
    //   149: aload_0
    //   150: invokespecial 321	com/tencent/wxop/stat/au:i	()V
    //   153: aload_2
    //   154: ifnull -124 -> 30
    //   157: aload_0
    ...
    //   164: ifle +7 -> 171
    //   167: aload_0
    //   168: invokespecial 321	com/tencent/wxop/stat/au:i	()V
    //   171: aload_2
    //   172: invokeinterface 311 1 0
    //   177: goto -147 -> 30
    //   180: astore_1
    //   181: aload_0
    //   182: monitorexit
    ...
    //   start	length	slot	name	signature
    //   0	185	0	this	au
    //   0	185	1	paramE	com.tencent.wxop.stat.a.e
    //   0	185	2	paramH	h
  ...
  private void b(f paramF)
  {
    ...
    //   6: astore 7
    //   8: aload 7
    //   10: invokestatic 447	com/tencent/wxop/stat/common/k:a	(Ljava/lang/String;)Ljava/lang/String;
    //   13: astore 5
    //   15: new 250	android/content/ContentValues
    //   18: dup
    //   19: invokespecial 251	android/content/ContentValues:<init>	()V
    //   22: astore 8
    //   24: aload 8
    //   26: ldc_w 259
    //   29: aload_1
    ...
    //   36: invokevirtual 268	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   39: aload 8
    //   41: ldc_w 455
    //   44: aload 5
    //   46: invokevirtual 268	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   49: aload_1
    //   50: aload 5
    ...
    //   134: invokevirtual 240	com/tencent/wxop/stat/bc:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   137: invokevirtual 228	android/database/sqlite/SQLiteDatabase:beginTransaction	()V
    //   140: iconst_1
    //   141: iload_2
    ...
    //   153: invokevirtual 240	com/tencent/wxop/stat/bc:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   156: ldc_w 466
    //   159: aload 8
    //   161: ldc_w 482
    //   164: iconst_1
    ...
    //   174: invokestatic 279	java/lang/Integer:toString	(I)Ljava/lang/String;
    //   177: aastore
    ...
    //   227: invokevirtual 240	com/tencent/wxop/stat/bc:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   230: invokevirtual 300	android/database/sqlite/SQLiteDatabase:setTransactionSuccessful	()V
    //   233: aload 6
    //   235: ifnull +10 -> 245
    //   238: aload 6
    ...
    //   249: invokevirtual 240	com/tencent/wxop/stat/bc:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   252: invokevirtual 303	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   255: aload_0
    //   256: monitorexit
    //   257: return
    //   258: aload 6
    ...
    //   285: invokevirtual 240	com/tencent/wxop/stat/bc:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   288: ldc_w 466
    //   291: aconst_null
    //   292: aload 8
    //   294: invokevirtual 297	android/database/sqlite/SQLiteDatabase:insert	(Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;)J
    //   297: lstore_3
    //   298: goto -115 -> 183
    //   301: aload 6
    //   303: astore 5
    ...
    //   326: invokevirtual 307	com/tencent/wxop/stat/common/StatLogger:d	(Ljava/lang/Object;)V
    //   329: goto -110 -> 219
    //   332: astore_1
    //   333: aload 6
    //   335: astore 5
    ...
    //   360: invokevirtual 240	com/tencent/wxop/stat/bc:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   363: invokevirtual 303	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   366: goto -111 -> 255
    //   369: astore_1
    //   370: goto -115 -> 255
    //   373: astore_1
    ...
    //   393: invokevirtual 240	com/tencent/wxop/stat/bc:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   396: invokevirtual 303	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   399: aload_1
    //   400: athrow
    //   401: astore_1
    //   402: aload_0
  ...
  private void b(List<bd> paramList, int paramInt, boolean paramBoolean)
  {
    ...
    //   5: astore 7
    //   7: iconst_1
    //   8: invokestatic 279	java/lang/Integer:toString	(I)Ljava/lang/String;
    //   11: astore 8
    //   13: iload_2
    //   14: invokestatic 279	java/lang/Integer:toString	(I)Ljava/lang/String;
    //   17: astore 9
    //   19: aload 7
    //   21: ldc -14
    //   23: aconst_null
    //   24: ldc_w 379
    //   27: iconst_1
    //   28: anewarray 381	java/lang/String
    //   31: dup
    //   32: iconst_0
    //   33: aload 8
    //   35: aastore
    ...
    //   38: aconst_null
    //   39: aload 9
    //   41: invokevirtual 498	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   44: astore 7
    //   46: aload 7
    //   48: invokeinterface 475 1 0
    //   53: ifeq +173 -> 226
    //   56: aload 7
    //   58: iconst_0
    //   59: invokeinterface 502 2 0
    //   64: lstore 5
    //   66: aload 7
    //   68: iconst_1
    //   69: invokeinterface 505 2 0
    //   74: astore 9
    //   76: aload 9
    //   78: astore 8
    //   80: getstatic 507	com/tencent/wxop/stat/StatConfig:g	Z
    //   83: ifne +10 -> 93
    //   86: aload 9
    //   88: invokestatic 508	com/tencent/wxop/stat/common/q:a	(Ljava/lang/String;)Ljava/lang/String;
    //   91: astore 8
    //   93: aload 7
    //   95: iconst_2
    ...
    //   110: istore 4
    //   112: new 162	com/tencent/wxop/stat/bd
    //   115: dup
    //   116: lload 5
    //   118: aload 8
    //   120: iload_2
    //   121: iload 4
    //   123: invokespecial 511	com/tencent/wxop/stat/bd:<init>	(JLjava/lang/String;II)V
    //   126: astore 8
    //   128: invokestatic 184	com/tencent/wxop/stat/StatConfig:isDebugEnable	()Z
    //   131: ifeq +55 -> 186
    //   134: getstatic 40	com/tencent/wxop/stat/au:h	Lcom/tencent/wxop/stat/common/StatLogger;
    ...
    //   158: iload 4
    //   160: invokevirtual 189	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   163: ldc_w 517
    //   166: invokevirtual 105	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   169: aload 7
    //   171: iconst_4
    //   172: invokeinterface 502 2 0
    ...
    //   183: invokevirtual 194	com/tencent/wxop/stat/common/StatLogger:i	(Ljava/lang/Object;)V
    //   186: aload_1
    //   187: aload 8
    //   189: invokeinterface 521 2 0
    //   194: pop
    //   195: goto -149 -> 46
    //   198: astore 8
    //   200: aload 7
    ...
    //   203: aload 8
    //   205: astore 7
    //   207: getstatic 40	com/tencent/wxop/stat/au:h	Lcom/tencent/wxop/stat/common/StatLogger;
    //   210: aload 7
    //   212: invokevirtual 131	com/tencent/wxop/stat/common/StatLogger:e	(Ljava/lang/Throwable;)V
    //   215: aload_1
    //   216: ifnull +9 -> 225
    //   219: aload_1
    //   220: invokeinterface 489 1 0
    //   225: return
    //   226: aload 7
    //   228: ifnull -3 -> 225
    //   231: aload 7
    //   233: invokeinterface 489 1 0
    //   238: return
    //   239: astore_1
    //   240: aconst_null
    //   241: astore 7
  ...
  private int g()
  {
    return (int)DatabaseUtils.queryNumEntries(c.getReadableDatabase(), "events");
  }
  
  private int h()
  {
    return (int)DatabaseUtils.queryNumEntries(d.getReadableDatabase(), "events");
  }
  ...
  private void i()
  {
    ...
    m = true;
    if (StatConfig.isDebugEnable()) {
      h.i("insert " + l.size() + " events ,numEventsCachedInMemory:" + StatConfig.m + ",numStoredEvents:" + a);
    }
    try
    {
      ...
      for (;;)
      {
        ...
        localObject3 = localSQLiteDatabase;
        localObject5 = localSQLiteDatabase;
        com.tencent.wxop.stat.a.e localE = (com.tencent.wxop.stat.a.e)((Map.Entry)localIterator.next()).getKey();
        localObject3 = localSQLiteDatabase;
        localObject5 = localSQLiteDatabase;
        ContentValues localContentValues = new ContentValues();
        localObject3 = localSQLiteDatabase;
    ...
    catch (Throwable localThrowable4)
    {
      ...
      try
      {
        ...
        for (;;)
        {
          m = false;
          if (StatConfig.isDebugEnable()) {
            h.i("after insert, cacheEventsInMemory.size():" + l.size() + ",numEventsCachedInMemory:" + StatConfig.m + ",numStoredEvents:" + a);
          }
          return;
  ...
  void a(int paramInt)
  {
    e.a(new bb(this, paramInt));
  }
  
  void a(com.tencent.wxop.stat.a.e paramE, h paramH, boolean paramBoolean1, boolean paramBoolean2)
  {
    if (e != null) {
      e.a(new ay(this, paramE, paramH, paramBoolean1, paramBoolean2));
    }
  }
  ...
  void a(f paramF)
  {
    ...
    e.a(new az(this, paramF));
  }
  
  void a(List<bd> paramList, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    if (e != null) {
      e.a(new av(this, paramList, paramInt, paramBoolean1, paramBoolean2));
    }
  }
  ...
  {
    if (e != null) {
      e.a(new aw(this, paramList, paramBoolean1, paramBoolean2));
    }
  }
  ...
  public a b(Context paramContext)
  {
    ...
    //   22: invokevirtual 240	com/tencent/wxop/stat/bc:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   25: invokevirtual 228	android/database/sqlite/SQLiteDatabase:beginTransaction	()V
    ...
    //   85: astore 16
    //   87: aload 16
    //   89: invokestatic 508	com/tencent/wxop/stat/common/q:a	(Ljava/lang/String;)Ljava/lang/String;
    //   92: astore 12
    //   94: aload 11
    //   96: iconst_1
    ...
    //   141: ldc2_w 593
    //   144: lmul
    //   145: invokestatic 596	com/tencent/wxop/stat/common/k:a	(J)Ljava/lang/String;
    //   148: ldc2_w 593
    //   151: lload 8
    //   153: lmul
    //   154: invokestatic 596	com/tencent/wxop/stat/common/k:a	(J)Ljava/lang/String;
    ...
    //   165: aload 10
    //   167: aload_1
    //   168: invokestatic 601	com/tencent/wxop/stat/common/k:n	(Landroid/content/Context;)Ljava/lang/String;
    ...
    //   227: aload_1
    //   228: invokestatic 610	com/tencent/wxop/stat/common/q:a	(Landroid/content/Context;)Ljava/lang/String;
    //   231: astore 13
    //   233: aload 13
    //   235: ifnull +629 -> 864
    //   238: aload 13
    ...
    //   321: new 250	android/content/ContentValues
    //   324: dup
    //   325: invokespecial 251	android/content/ContentValues:<init>	()V
    //   328: astore 10
    //   330: aload 10
    //   332: ldc_w 618
    //   335: aload 13
    //   337: invokestatic 264	com/tencent/wxop/stat/common/q:b	(Ljava/lang/String;)Ljava/lang/String;
    //   340: invokevirtual 268	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   343: aload 10
    //   345: ldc_w 620
    //   348: iload_3
    ...
    //   357: ldc_w 622
    //   360: aload_1
    //   361: invokestatic 601	com/tencent/wxop/stat/common/k:n	(Landroid/content/Context;)Ljava/lang/String;
    //   364: invokevirtual 268	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   367: aload 10
    //   369: ldc_w 624
    //   372: lload 8
    //   374: invokestatic 290	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   377: invokevirtual 293	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Long;)V
    //   380: iload 4
    //   382: ifeq +31 -> 413
    //   385: aload_0
    //   386: getfield 53	com/tencent/wxop/stat/au:c	Lcom/tencent/wxop/stat/bc;
    //   389: invokevirtual 240	com/tencent/wxop/stat/bc:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   392: ldc_w 587
    //   395: aload 10
    //   397: ldc_w 626
    //   400: iconst_1
    ...
    //   423: invokevirtual 240	com/tencent/wxop/stat/bc:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   426: ldc_w 587
    //   429: aconst_null
    //   430: aload 10
    ...
    //   440: ifne +158 -> 598
    //   443: aload_1
    //   444: invokestatic 631	com/tencent/wxop/stat/common/k:b	(Landroid/content/Context;)Ljava/lang/String;
    //   447: astore 12
    //   449: aload_1
    //   450: invokestatic 633	com/tencent/wxop/stat/common/k:c	(Landroid/content/Context;)Ljava/lang/String;
    //   453: astore 13
    //   455: aload 13
    //   457: ifnull +400 -> 857
    //   460: aload 13
    ...
    //   502: lstore 6
    //   504: aload_1
    //   505: invokestatic 601	com/tencent/wxop/stat/common/k:n	(Landroid/content/Context;)Ljava/lang/String;
    //   508: astore_1
    //   509: new 250	android/content/ContentValues
    //   512: dup
    //   513: invokespecial 251	android/content/ContentValues:<init>	()V
    //   516: astore 14
    //   518: aload 14
    //   520: ldc_w 618
    //   523: aload 10
    //   525: invokestatic 264	com/tencent/wxop/stat/common/q:b	(Ljava/lang/String;)Ljava/lang/String;
    //   528: invokevirtual 268	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   531: aload 14
    //   533: ldc_w 620
    //   536: iconst_0
    ...
    //   545: ldc_w 622
    //   548: aload_1
    //   549: invokevirtual 268	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/String;)V
    //   552: aload 14
    //   554: ldc_w 624
    //   557: lload 6
    //   559: invokestatic 290	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   562: invokevirtual 293	android/content/ContentValues:put	(Ljava/lang/String;Ljava/lang/Long;)V
    //   565: aload_0
    //   566: getfield 53	com/tencent/wxop/stat/au:c	Lcom/tencent/wxop/stat/bc;
    //   569: invokevirtual 240	com/tencent/wxop/stat/bc:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   572: ldc_w 587
    //   575: aconst_null
    //   576: aload 14
    //   578: invokevirtual 297	android/database/sqlite/SQLiteDatabase:insert	(Ljava/lang/String;Ljava/lang/String;Landroid/content/ContentValues;)J
    //   581: pop2
    //   582: aload_0
    ...
    //   602: invokevirtual 240	com/tencent/wxop/stat/bc:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   605: invokevirtual 300	android/database/sqlite/SQLiteDatabase:setTransactionSuccessful	()V
    //   608: aload 11
    //   610: ifnull +10 -> 620
    //   613: aload 11
    ...
    //   624: invokevirtual 240	com/tencent/wxop/stat/bc:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   627: invokevirtual 303	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   630: aload_0
    //   631: getfield 67	com/tencent/wxop/stat/au:b	Lcom/tencent/wxop/stat/common/a;
    //   634: astore_1
    //   635: goto -621 -> 14
    //   638: aload_1
    //   639: invokestatic 631	com/tencent/wxop/stat/common/k:b	(Landroid/content/Context;)Ljava/lang/String;
    //   642: astore 10
    //   644: iconst_1
    //   645: istore_2
    //   646: aload 10
    ...
    //   650: goto -393 -> 257
    //   653: aload_1
    //   654: invokestatic 633	com/tencent/wxop/stat/common/k:c	(Landroid/content/Context;)Ljava/lang/String;
    //   657: astore 15
    //   659: iload_2
    //   660: istore 4
    //   662: aload 15
    ...
    //   773: invokevirtual 240	com/tencent/wxop/stat/bc:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   776: invokevirtual 303	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   779: goto -149 -> 630
    //   782: astore_1
    ...
    //   813: invokevirtual 240	com/tencent/wxop/stat/bc:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   816: invokevirtual 303	android/database/sqlite/SQLiteDatabase:endTransaction	()V
    //   819: aload_1
    //   820: athrow
    //   821: astore 10
