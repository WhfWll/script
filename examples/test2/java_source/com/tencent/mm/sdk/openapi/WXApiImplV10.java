  ...
  implements IWXAPI
{
  ...
  {
    paramContext = paramContext.getContentResolver().query(Uri.parse("content://com.tencent.mm.sdk.comm.provider/createChatroom"), null, null, new String[] { appId, paramBundle.getString("_wxapi_basereq_transaction"), paramBundle.getString("_wxapi_create_chatroom_group_id"), paramBundle.getString("_wxapi_create_chatroom_chatroom_name"), paramBundle.getString("_wxapi_create_chatroom_chatroom_nickname"), paramBundle.getString("_wxapi_create_chatroom_ext_msg") }, null);
  ...
  private void initMta(Context paramContext, String paramString)
  {
    ...
    try
    {
      StatService.startStatService(paramContext, paramString, "2.0.3");
      return;
    }
  ...
  {
    paramContext = paramContext.getContentResolver().query(Uri.parse("content://com.tencent.mm.sdk.comm.provider/joinChatroom"), null, null, new String[] { appId, paramBundle.getString("_wxapi_basereq_transaction"), paramBundle.getString("_wxapi_join_chatroom_group_id"), paramBundle.getString("_wxapi_join_chatroom_chatroom_nickname"), paramBundle.getString("_wxapi_join_chatroom_ext_msg") }, null);
    if (paramContext != null) {
      paramContext.close();
    }
    return true;
  ...
  {
    paramContext = paramContext.getContentResolver().query(Uri.parse("content://com.tencent.mm.sdk.comm.provider/addCardToWX"), null, null, new String[] { appId, paramBundle.getString("_wxapi_add_card_to_wx_card_list"), paramBundle.getString("_wxapi_basereq_transaction") }, null);
    if (paramContext != null) {
      paramContext.close();
    }
    return true;
  ...
  {
    paramContext = paramContext.getContentResolver().query(Uri.parse("content://com.tencent.mm.sdk.comm.provider/jumpToBizProfile"), null, null, new String[] { appId, paramBundle.getString("_wxapi_jump_to_biz_profile_req_to_user_name"), paramBundle.getString("_wxapi_jump_to_biz_profile_req_ext_msg"), paramBundle.getInt("_wxapi_jump_to_biz_profile_req_scene"), paramBundle.getInt("_wxapi_jump_to_biz_profile_req_profile_type") }, null);
    if (paramContext != null) {
      paramContext.close();
    }
    return true;
  ...
  {
    paramContext = paramContext.getContentResolver().query(Uri.parse("content://com.tencent.mm.sdk.comm.provider/jumpToBizTempSession"), null, null, new String[] { appId, paramBundle.getString("_wxapi_jump_to_biz_webview_req_to_user_name"), paramBundle.getString("_wxapi_jump_to_biz_webview_req_session_from"), paramBundle.getInt("_wxapi_jump_to_biz_webview_req_show_type") }, null);
    if (paramContext != null) {
      paramContext.close();
    }
    return true;
  ...
  {
    paramContext = paramContext.getContentResolver().query(Uri.parse("content://com.tencent.mm.sdk.comm.provider/jumpToBizProfile"), null, null, new String[] { appId, paramBundle.getString("_wxapi_jump_to_biz_webview_req_to_user_name"), paramBundle.getString("_wxapi_jump_to_biz_webview_req_ext_msg"), paramBundle.getInt("_wxapi_jump_to_biz_webview_req_scene") }, null);
    if (paramContext != null) {
      paramContext.close();
    }
    return true;
  ...
  {
    paramContext = paramContext.getContentResolver().query(Uri.parse("content://com.tencent.mm.sdk.comm.provider/openBusiLuckyMoney"), null, null, new String[] { appId, paramBundle.getString("_wxapi_open_busi_lucky_money_timeStamp"), paramBundle.getString("_wxapi_open_busi_lucky_money_nonceStr"), paramBundle.getString("_wxapi_open_busi_lucky_money_signType"), paramBundle.getString("_wxapi_open_busi_lucky_money_signature"), paramBundle.getString("_wxapi_open_busi_lucky_money_package") }, null);
    if (paramContext != null) {
      paramContext.close();
    }
    return true;
  ...
  {
    paramContext = paramContext.getContentResolver().query(Uri.parse("content://com.tencent.mm.sdk.comm.provider/openWebview"), null, null, new String[] { appId, paramBundle.getString("_wxapi_jump_to_webview_url"), paramBundle.getString("_wxapi_basereq_transaction") }, null);
    if (paramContext != null) {
      paramContext.close();
    }
    return true;
  ...
  public final boolean isWXAppInstalled()
  {
    ...
    try
    {
      PackageInfo localPackageInfo = context.getPackageManager().getPackageInfo("com.tencent.mm", 64);
      if (localPackageInfo == null) {
        return false;
      }
      boolean bool = WXApiImplComm.validateAppSignature(context, signatures, checkSignature);
      return bool;
    }
  ...
  public final boolean registerApp(String paramString)
  {
    ...
    if ((activityCb == null) && (Build.VERSION.SDK_INT >= 14))
    {
      ...
      initMta(context, paramString);
      activityCb = new ActivityLifecycleCb(context, null);
    ...
    for (;;)
    {
      ...
      com.tencent.mm.sdk.b.b.e("MicroMsg.SDK.WXApiImplV10", "register app " + context.getPackageName());
      paramString = new com.tencent.mm.sdk.a.a.a.a();
      aa = "com.tencent.mm";
      ab = "com.tencent.mm.plugin.openapi.Intent.ACTION_HANDLE_APP_REGISTER";
      Y = ("weixin://registerapp?appid=" + appId);
      return com.tencent.mm.sdk.a.a.a.a(context, paramString);
      label223:
      if ((context instanceof Service))
      {
        initMta(context, paramString);
  ...
  public final boolean sendReq(BaseReq paramBaseReq)
  {
    ...
    if (paramBaseReq.getType() == 5) {
      return sendPayReq(context, localBundle);
    }
    if (paramBaseReq.getType() == 7) {
      return sendJumpToBizProfileReq(context, localBundle);
    }
    if (paramBaseReq.getType() == 8) {
      return sendJumpToBizWebviewReq(context, localBundle);
    }
    if (paramBaseReq.getType() == 10) {
      return sendJumpToBizTempSessionReq(context, localBundle);
    }
    if (paramBaseReq.getType() == 9) {
      return sendAddCardToWX(context, localBundle);
    }
    if (paramBaseReq.getType() == 11) {
      return sendOpenRankListReq(context, localBundle);
    }
    if (paramBaseReq.getType() == 12) {
      return sendOpenWebview(context, localBundle);
    }
    if (paramBaseReq.getType() == 13) {
      return sendOpenBusiLuckyMoney(context, localBundle);
    }
    if (paramBaseReq.getType() == 14) {
      return createChatroom(context, localBundle);
    }
    if (paramBaseReq.getType() == 15) {
      return joinChatroom(context, localBundle);
    }
    paramBaseReq = new com.tencent.mm.sdk.a.a.a();
    Z = localBundle;
    Y = ("weixin://sendreq?appid=" + appId);
    W = "com.tencent.mm";
    X = "com.tencent.mm.plugin.base.stub.WXEntryActivity";
    return com.tencent.mm.sdk.a.a.a(context, paramBaseReq);
  }
  ...
  public final boolean sendResp(BaseResp paramBaseResp)
  {
    ...
    Z = localBundle;
    Y = ("weixin://sendresp?appid=" + appId);
    W = "com.tencent.mm";
    X = "com.tencent.mm.plugin.base.stub.WXEntryActivity";
    return com.tencent.mm.sdk.a.a.a(context, paramBaseResp);
  }
  ...
  public final void unregisterApp()
  {
    ...
    com.tencent.mm.sdk.b.b.e("MicroMsg.SDK.WXApiImplV10", "unregisterApp, appId = " + appId);
    if ((appId == null) || (appId.length() == 0))
    {
      com.tencent.mm.sdk.b.b.b("MicroMsg.SDK.WXApiImplV10", "unregisterApp fail, appId is empty");
      return;
    }
    com.tencent.mm.sdk.b.b.e("MicroMsg.SDK.WXApiImplV10", "unregister app " + context.getPackageName());
    com.tencent.mm.sdk.a.a.a.a localA = new com.tencent.mm.sdk.a.a.a.a();
    aa = "com.tencent.mm";
    ab = "com.tencent.mm.plugin.openapi.Intent.ACTION_HANDLE_APP_UNREGISTER";
    Y = ("weixin://unregisterapp?appid=" + appId);
    com.tencent.mm.sdk.a.a.a.a(context, localA);
  }
