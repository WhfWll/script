  ...
  static final class a
  {
    ...
    public static a d(byte[] paramArrayOfByte)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          if (i != 0)
          {
            ...
            at = i;
            au = paramArrayOfByte.optString("errmsg");
            return localA;
          }
        }
      ...
      if ((localObject == null) || (((String)localObject).length() == 0))
      {
        ...
        ap = OAuthErrCode.WechatAuth_Err_JsonDecodeErr;
        return localA;
      }
      ...
      if (d.r())
      {
        ...
        as = d.s();
        aq = paramArrayOfByte.getString("uuid");
        ar = paramArrayOfByte.getString("appname");
        Log.d("MicroMsg.SDK.GetQRCodeResult", String.format("parse succ, save in external storage, uuid = %s, appname = %s, imgPath = %s", new Object[] { aq, ar, as }));
        return localA;
      }
      ap = OAuthErrCode.WechatAuth_Err_OK;
      av = ((byte[])localObject);
      aq = paramArrayOfByte.getString("uuid");
      ar = paramArrayOfByte.getString("appname");
      Log.d("MicroMsg.SDK.GetQRCodeResult", String.format("parse succ, save in memory, uuid = %s, appname = %s, imgBufLength = %d", new Object[] { aq, ar, Integer.valueOf(av.length) }));
      return localA;
    }
  }
}
