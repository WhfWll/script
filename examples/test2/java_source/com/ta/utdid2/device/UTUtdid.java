...
public class UTUtdid
{
  ...
  public UTUtdid(Context paramContext)
  {
    ...
    mTaoPC = new PersistentConfiguration(paramContext, S_GLOBAL_PERSISTENT_CONFIG_DIR, "Alvin2", false, true);
    mPC = new PersistentConfiguration(paramContext, ".DataStorage", "ContextData", false, true);
    mUtdidHelper = new UTUtdidHelper();
    mCBKey = String.format("K_%d", new Object[] { Integer.valueOf(StringUtils.hashCode(mCBKey)) });
    mCBDomain = String.format("D_%d", new Object[] { Integer.valueOf(StringUtils.hashCode(mCBDomain)) });
  }
  ...
  private native void _removeIllegalKeys();
