  ...
  extends Plugin
{
  ...
  static
  {
    JniLib.a(ChildBrowser.class, 989);
    CLOSE_EVENT = 0;
  ...
  class AlipayResult
  {
    ...
    static
    {
      JniLib.a(AlipayResult.class, 983);
    }
    ...
    public AlipayResult(String paramString)
    {
      ...
      for (;;)
      {
        ...
        if (paramString.startsWith("resultStatus")) {
          resultStatus = gatValue(paramString, "resultStatus");
        }
        if (paramString.startsWith("result")) {
          result = gatValue(paramString, "result");
        }
        if (paramString.startsWith("memo")) {
          memo = gatValue(paramString, "memo");
        }
        i += 1;
      }
    }
    ...
    extends WebViewClient
  {
    ...
    static
    {
      JniLib.a(ChildBrowserClient.class, 985);
    }
  ...
  final class DemoJavaScriptInterface
  {
    static
    {
      JniLib.a(DemoJavaScriptInterface.class, 986);
    }
    ...
    implements DownloadListener
  {
    static
    {
      JniLib.a(MyWebViewDownLoadListener.class, 988);
    }
