...
public class WLClient
{
  ...
  static
  {
    JniLib.a(WLClient.class, 1231);
  }
  
  private WLClient(Context paramContext)
  {
    config = new WLConfig(paramContext);
    httpContext = new BasicHttpContext();
    context = paramContext;
    chMap = new Hashtable();
    globalHeaders = new Hashtable();
    ...
    extends TimerTask
  {
    ...
    static
    {
      JniLib.a(HeartBeatTask.class, 1226);
    }
    ...
    implements WLRequestListener
  {
    static
    {
      JniLib.a(HeartbeatListener.class, 1227);
    }
    ...
    implements WLRequestListener
  {
    static
    {
      JniLib.a(InitRequestListener.class, 1228);
    }
    ...
    implements WLRequestListener
  {
    static
    {
      JniLib.a(InvokeProcedureRequestListener.class, 1229);
    }
    ...
    implements WLRequestListener
  {
    static
    {
      JniLib.a(LogActivityListener.class, 1230);
    }
