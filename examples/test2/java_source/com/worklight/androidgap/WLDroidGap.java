  ...
  implements WLDroidGapListener
{
  ...
  public class PrepackagedAssetsManager
  {
    ...
    static
    {
      JniLib.a(PrepackagedAssetsManager.class, 1086);
    }
      ...
      implements Comparable<Checksum>
    {
      ...
      static
      {
        JniLib.a(Checksum.class, 1085);
      }
      
      public Checksum(JSONObject paramJSONObject)
        throws JSONException
      {
        checksum = paramJSONObject.getString("checksum");
        date = Long.valueOf(paramJSONObject.getLong("date"));
        machine = paramJSONObject.getString("machine");
      }
    ...
    extends AsyncTask<Bundle, Void, Bundle>
  {
    static
    {
      JniLib.a(PrepareClientAsyncTask.class, 1087);
    }
