...
public class ReadableDatabase
{
  ...
  static
  {
    JniLib.a(ReadableDatabase.class, 1095);
  }
  ...
  public Cursor findByIds(int... paramVarArgs)
  {
    ...
    return rawQuery(JsonstoreUtil.formatString("SELECT {0}, {1} FROM {2} WHERE {3} AND _deleted = 0", new Object[] { "_id", "json", schema.getName(), localStringBuilder.toString() }), arrayOfString);
  }
