  ...
  implements DatabaseAccessor
{
  ...
  static
  {
    JniLib.a(DatabaseAccessorImpl.class, 1092);
  ...
  protected DatabaseAccessorImpl(SQLiteDatabase paramSQLiteDatabase, DatabaseSchema paramDatabaseSchema)
  {
    ...
    readableDB = new ReadableDatabase(paramSQLiteDatabase, paramDatabaseSchema);
    schema = paramDatabaseSchema;
    writableDB = new WritableDatabase(paramSQLiteDatabase, paramDatabaseSchema);
  }
  ...
  private void execSQL(String paramString, Object... paramVarArgs)
  {
    ...
    {
      logger.logDebug("executing SQL on database \"" + schema.getName() + "\":");
      logger.logDebug("   " + paramString);
    }
    writableDB.getDatabase().execSQL(paramString);
  }
