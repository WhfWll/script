  ...
  extends AsyncTask<Object, Integer, Boolean>
{
  ...
  protected Boolean doInBackground(Object... paramVarArgs)
  {
    try
    {
      ...
      localHttpUtils.send(HttpRequest.HttpMethod.POST, "https://mobile.12306.cn/otsmobile/track/alaunch", localRequestParams, new RequestCallBack()
      {
        static
        {
          JniLib.a(1.class, 19);
