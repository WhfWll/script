  ...
  extends jh
{
  ...
  {
    super(paramReader);
    jdField_a_of_type_Iv = paramIv;
    jdField_a_of_type_JavaUtilMap.put("CERTIFICATE", new it(paramString2));
    jdField_a_of_type_JavaUtilMap.put("RSA PRIVATE KEY", new is(this, paramString1, paramString2));
  }
    ...
    throws IOException
  {
    ...
    return a(localObject, paramArrayOfByte1, paramArrayOfChar, paramString2, paramArrayOfByte2);
  }
    ...
    throws IOException
  {
    ...
    if (localObject1 != null)
    {
      ...
      if (i > 0)
      {
        String str1 = "-----END " + (String)localObject1;
        ...
        for (;;)
        {
          ...
          {
            i = str2.indexOf(':');
            localArrayList.add(new je(str2.substring(0, i), str2.substring(i + 1).trim()));
          }
          else
          {
    ...
    for (localObject1 = new jf((String)localObject1, localArrayList, iw.a(localStringBuffer.toString()));; localObject1 = null)
    {
      if (localObject1 != null)
      {
        localObject2 = ((jf)localObject1).a();
        if (!jdField_a_of_type_JavaUtilMap.containsKey(localObject2)) {
          break;
        }
        localObject2 = ((jg)jdField_a_of_type_JavaUtilMap.get(localObject2)).a((jf)localObject1);
      }
      return localObject2;
    }
